...
LICENSE="GPL-2+"
SLOT="2"
IUSE="+bluetooth +colord debug +gnome-online-accounts +i18n input_devices_wacom kerberos networkmanager v4l wayland cups"
...
src_prepare() {
	...
	eapply "${FILESDIR}"/${P}-printers-optional.patch
