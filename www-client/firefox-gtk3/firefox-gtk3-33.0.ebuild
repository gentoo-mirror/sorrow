...
inherit check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils mozcoreconf-2 multilib pax-utils fdo-mime autotools virtualx rpm
...
IUSE="+alsa bindist +dbus debug gstreamer hardened +jit libnotify +minimal pgo pulseaudio startup-notification system-icu system-jpeg system-sqlite test wifi"

SRC_URI="http://copr-be.cloud.fedoraproject.org/results/stransky/FirefoxGtk3/fedora-rawhide-x86_64/${P}-1.fc20/${P}-1.fc21.src.rpm"
...
src_configure() {
	...
	echo "mk_add_options MOZ_OBJDIR=@TOPSRCDIR@/objdir" >> "${S}"/.mozconfig
